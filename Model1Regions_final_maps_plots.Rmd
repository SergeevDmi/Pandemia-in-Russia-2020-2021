...
map_district<-ggplot(mapdata1, aes( x = `long`, y = `lat`, group=group)) +geom_polygon(aes(), color = "black")+
  ...
  geom_polygon( data = (mapdata1[mapdata1$id == "45",]), aes( x = `long`, y = `lat`, group=group), color = "deepskyblue")+   geom_polygon( data = (mapdata1[mapdata1$id == "61",]), aes( x = `long`, y = `lat`, group=group), color = "deepskyblue")+
...
```{r}
setwd("C:/Users/AVGUST/Desktop/R_ regions/2020district")
library('dplyr')
plot_region <- function(x = "1"){
...
```{r}
setwd("C:/Users/AVGUST/Desktop/R_ regions/2021disrtrict")
plot_region <- function(x = "1"){
