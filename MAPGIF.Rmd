...
centroids_df = as.data.frame(coordinates(gadm.prj))


centroids_df$id = unique(mapdata1$id)

# переносим каждое слово на новую строку

centroids_df <- inner_join(centroids_df,mydata,by="id")
...
```{r}
library(magick)
img <- c(JPGDR1,JPGDR2,JPGDR3,JPGDR4,JPGDR5,JPGDR6,JPGDR7,JPGDR8,JPGDR9,JPGDR10,JPGDR11,JPGDR12,JPMAP2,JPGDR13,JPGDR14,JPGDR15,JPGDR16,JPGDR17,JPGDR18,JPGDR19,JPGDR20,JPGDR21,JPGDR22,JPGDR23,JPGDR24,JPMAP3)
...
```{r}
my.animation<-image_animate(image_scale(img, "1000x1000"), fps = 1, dispose = "previous")
image_write(my.animation, "map2020-2021.gif")
my.animation
